...
function AddReview() {
  ...
  // Mock station data - replace with actual data from props/route
  const station = {
    name: 'Tesla Supercharger Downtown',
    address: '123 Main Street, City Center',
    power: 150,
    chargedAmount: '45 kWh',
    totalCost: '₹540'
  };
  ...
  try {
    ...
    const response = await fetch('http://localhost:5000/api/auth/addreview', {
      ...
      body: JSON.stringify({
        requestId: requestId, // from route params
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Your review has been submitted successfully. It helps others find the best charging stations!
          </p>
          <button
      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: '24px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              <p style={{ fontSize: '12px', color: '#64748b', margin: '0 0 4px 0' }}>Power</p>
              <p style={{ fontSize: '18px', fontWeight: 'bold', color: '#0f172a', margin: 0 }}>
                {station.power} kW
              </p>
            </div>
            <div style={{ textAlign: 'center' }}>
              <p style={{ fontSize: '12px', color: '#64748b', margin: '0 0 4px 0' }}>Charged</p>
              <p style={{ fontSize: '18px', fontWeight: 'bold', color: '#0f172a', margin: 0 }}>
                {station.chargedAmount}
              </p>
            </div>
            <div style={{ textAlign: 'center' }}>
              <p style={{ fontSize: '12px', color: '#64748b', margin: '0 0 4px 0' }}>Total Cost</p>
              <p style={{ fontSize: '18px', fontWeight: 'bold', color: '#0f172a', margin: 0 }}>
                {station.totalCost}
              </p>
            </div>
        ...
        <div style={{
            ...
            {[1, 2, 3, 4, 5].map((star) => (
              <span
                ...
                style={{
                  ...
                  filter: star <= (hoverRating || rating) ? 'drop-shadow(0 2px 4px rgba(251,191,36,0.5))' : 'none'
                }}
              >
                ★
              </span>
          ...
          {rating > 0 && (
            <p style={{
              ...
              fontSize: '18px',
              fontWeight: '600',
              color: rating >= 4 ? '#059669' : rating >= 3 ? '#f59e0b' : '#ef4444',
            ...
            {reviewTags.map((tag) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: '12px',
                  border: '2px solid',
                  borderColor: selectedTags.includes(tag.id) ? '#059669' : '#e2e8f0',
                  background: selectedTags.includes(tag.id) ? '#d1fae5' : 'white',
        ...
        <button
          ...
          style={{
            ...
            boxShadow: rating === 0 || isSubmitting ? 'none' : '0 4px 16px rgba(5,150,105,0.4)',
            transition: 'all 0.3s',
